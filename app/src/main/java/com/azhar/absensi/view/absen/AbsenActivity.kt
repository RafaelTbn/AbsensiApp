...
class AbsenActivity : AppCompatActivity() {
    ...
    private fun setUploadData() {
        btnAbsen.setOnClickListener {
            ...
            val strNRP = inputNRP.text.toString()
            val strMataKuliah = inputMataKuliah.text.toString()
            val strRuangan = inputRuangan.text.toString()

            if (strFilePath.isEmpty() || strNama.isEmpty() || strCurrentLocation.isEmpty()
                || strTanggal.isEmpty() || strKeterangan.isEmpty() || strNRP.isEmpty()
                || strMataKuliah.isEmpty() || strRuangan.isEmpty()) {
                Toast.makeText(this@AbsenActivity,
