...
class HistoryAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvNRP.text = data.nrp
        holder.tvMataKuliah.text = data.mataKuliah
        holder.tvRuangan.text = data.ruangan
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var tvNRP: TextView = itemView.tvNRP
        var tvMataKuliah: TextView = itemView.tvMataKuliah
        var tvRuangan: TextView = itemView.tvRuangan
